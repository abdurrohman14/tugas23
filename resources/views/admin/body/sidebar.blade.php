      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="ti-more"></i>Tampilkan User</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('products.view') }}"><i class="ti-more"></i>Tampilkan Product</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="ti-more"></i>Tampilkan Buku</a></li>
            {{-- <li><a href="calendar.html"><i class="ti-more"></i>Tambah MataKuliah</a></li> --}}
          </ul>
        </li> 
